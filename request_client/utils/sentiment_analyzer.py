...
# Calc mean of all compund scores and find review
def review_type(
        compound_scores: list = [0]) -> Literal['Positive', 'Negative']:
...
def main(comment_lst: list = []):
    ...
    flat_sent_token = [
        item for sublist in nested_sent_token for item in sublist
    ]
